...
import { HomeIcon, NotebookIcon, UsbIcon} from "lucide-react";
...
export const DATA = {
  ...
  projects: [
    {
      title: "Pinitup",
      href: "https://chromewebstore.google.com/detail/pinitup/bdlikbaegahppphbllkecmegphbaodnm",
      dates: "",
      active: true,
      description:
        "I got tired of the typical bookmarking features in browsers, so I decided to create my own bookmarking extension with a modern design, prioritizing ease of use and a more streamlined experience.",
      technologies: [
        "React",
        "Javascript",
        "Chrome API",
    ...
    {
      title: "Heiwa",
      href: "https://heiwa.vercel.app/",
      dates: "",
      active: true,
      description:
        "Heiwa is an end-to-end anonymous chatting application designed for people struggling with their mental health.",
      technologies: [
        "React",
        "Javascript",
        "Nodejs",
      ...
      links: [
        ...
        {
          type: "Source",
          href: "https://github.com/AthN3090/Heiwa-react",
    ...
    {
      title: "Write-er",
      href: "https://write-er-app.vercel.app/",
      dates: "",
      active: true,
      description:
        "Write-er is a minimalist blogging platform built using React-Markdown, and developed with the MERN stack",
      technologies: [
        "React",
        "Javascript",
        "Nodejs",
      ...
      links: [
        {
          type: "Website",
          href: "https://write-er-app.vercel.app/t",
          icon: <Icons.globe className="size-3" />,
        },
        {
          type: "Source",
          href: "https://github.com/AthN3090/write-er-app",
          icon: <Icons.github className="size-3" />,
        },
      ],
      image: "/write-er.jpg",
    ...
    },
    {
      ...
      active: true,
      description:
        "Implementation of the classic old school minesweeper game in React",
      technologies: [
        "React",
        "Typescript",
        "TailwindCSS",
    ...
    },
    {
      ...
      active: true,
      description:
        "Simple landing page for a biometric application.",
      technologies: [
        "Nextjs",
        "React",
        "Javascript",
